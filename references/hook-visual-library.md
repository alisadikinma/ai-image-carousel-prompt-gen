...
| 7 | **Brand chrome** | Page number top-left; brand icon + watermark centered, rendered **faint and barely-visible (subtle semi-transparent background watermark, never fully opaque)**. The brand icon is **a bald head with rectangular glasses and no hair** — render it to match the brand mark exactly, never add hair. **The opacity is a rendering instruction ONLY — never draw the words "opacity"/"thirty percent"/"30%" or any percentage label in the image.** |
